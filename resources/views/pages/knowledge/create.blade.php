    ...
    <div class="py-6 max-w-2xl mx-auto">
        ...
        <form action="{{ route('send.prompt') }}" method="POST" class="mt-4">
            ...
            <div class="mb-4">
                ...
                <input type="number" id="reponsesCount" name="reponsesCount" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" value="4" min="1" required />
            </div>
