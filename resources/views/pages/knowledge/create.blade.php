    ...
    <div class="py-6 max-w-2xl mx-auto">
        ...
        @if ($errors->any())
            <div class="mb-6 bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded">
                <strong>Oups !</strong> Il y a eu un problème avec votre saisie :
        ...
        <form action="{{ route('send.prompt') }}" method="POST" class="mt-4">
            ...
            <div class="mb-4">
                ...
                <input type="number" id="questionsCount" name="questionsCount"
                    class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
            ...
            <div class="mb-4">
                <label for="reponsesCount" class="block text-sm font-medium text-gray-700">Nombre de réponses par
                    question</label>
                <input type="number" id="reponsesCount" name="reponsesCount"
                    class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                    value="4" min="2" required />
            </div>
